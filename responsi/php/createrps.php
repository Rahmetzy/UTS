...
if (isset($_POST['daftar'])) {
    ...
    if ($count[0] == 0) {
        ...
        $sql = "INSERT INTO matkuldb (matkul, deskripsi, materi1, materi2, materi3, materi5, materi6, materi7, materi8, materi9, materi10, materi11, materi12, materi13, materi14) 
        VALUES ('$matkul','$deskripsi', '$materi1', '$materi2', '$materi3', '$materi5', '$materi6', '$materi7', '$materi8', '$materi9', '$materi10', '$materi11', '$materi12', '$materi13', '$materi14')";
